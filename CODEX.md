...
- `/consejoia`, `/consejo_ia`, `/consejollm` — consultar al Consejo AdmiraNext via `CONSEJO_WEB_LLM_API_URL` (`http://127.0.0.1:8420` en local), siempre con `CONSEJO_WEB_LLM_MODEL=llama-70b` por defecto (Llama 3.3 gratuito)
